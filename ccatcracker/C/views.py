...
def download(request):
     ...
     file_path = r'/home/ccatcracker/pyapps/ccatcracker/ccatcracker/Networking.pdf'
    
     with open(file_path, 'rb') as fh:
          response = HttpResponse(fh.read(), content_type="application/vnd.ms-excel")
          response['Content-Disposition'] = 'inline; filename='+ r'/home/ccatcracker/pyapps/ccatcracker/ccatcracker/Networking.pdf'
          return response
